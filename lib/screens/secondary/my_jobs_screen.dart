...
import 'package:ccet_alumini_app/screens/secondary/job_viewer_screen.dart';
...
class _MyJobsScreenState extends State<MyJobsScreen> {
  ...
  void _loadMyJobs() {
    ...
    // We get all jobs and filter client-side for now, as API returns all
    _jobsFuture = ApiService.getJobs().then((jobs) {
      if (user == null) return [];
      return jobs.where((job) => job['postedBy'] == user.uid).toList();
    });
  }
